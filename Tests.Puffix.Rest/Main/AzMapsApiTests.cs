...
public class AzMapsApiTests
{
    ...
    public async Task Test()
    {
        ...
        try
        {
            ...
            IAzMapsApiQueryInformation queryInformation = httpRepository.BuildAuthenticatedQuery(token, HttpMethod.Get, azMapsBaseUri, azMapsSearchAddressQeuryPath, queryParameters, queryContent);
    ...
    public async Task UnitTest()
    {
        ...
        try
        {
            ...
            // Test
            IQueryContent queryContent = EmptyContent.CreateNew();
            IAzMapsApiQueryInformation queryInformation = httpRepository.BuildAuthenticatedQuery(token, HttpMethod.Get, azMapsBaseUri, azMapsSearchAddressQueryPath, queryParameters, queryContent);
            string actualResult = await httpRepository.HttpAsync(queryInformation);
